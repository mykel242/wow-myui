...
addon.VERSION = "7de5fca"
addon.BUILD_DATE = "2025-06-25-19:13"
...
function addon:OnInitialize()
    ...
    -- Initialize combat meter components
    if self.MyCombatMeterCalculator then
        self.MyCombatMeterCalculator:Initialize()
        self:Debug("MyCombatMeterCalculator initialized")
    end
    
    if self.MyCombatMeterScaler then
        self.MyCombatMeterScaler:Initialize()
