...
local function CreateConfigWindow()
    ...
    if not calculator then
        ...
        errorText:SetFont("Interface\\AddOns\\myui2\\SCP-SB.ttf", 12, "OUTLINE")
    ...
    methodLabel:SetFont("Interface\\AddOns\\myui2\\SCP-SB.ttf", 12, "OUTLINE")
    ...
    for methodKey, methodName in pairs(addon.UnifiedCalculator.CALCULATION_METHODS) do
        ...
        label:SetFont("Interface\\AddOns\\myui2\\SCP-SB.ttf", 11, "OUTLINE")
    ...
    validationLabel:SetFont("Interface\\AddOns\\myui2\\SCP-SB.ttf", 12, "OUTLINE")
    ...
    infoText:SetFont("Interface\\AddOns\\myui2\\SCP-SB.ttf", 10, "OUTLINE")
